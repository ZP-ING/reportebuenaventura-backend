...
import { Building2, Mail, Phone, MapPin, ExternalLink, MessageCircle, Search, Filter } from 'lucide-react';
...
export function EntityList() {
  ...
  // Filter entities by search term and category
        ...
        <CardHeader>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            ...
            <Select value={categoryFilter} onValueChange={setCategoryFilter}>
              <SelectTrigger className="w-full sm:w-64 border-green-200">
