...
export function AdminUsersManagement() {
  ...
  const handleSuspendUser = async () => {
    ...
    try {
      ...
      setUsers(updatedUsers);
      toast.success(`Usuario ${user.name} suspendido hasta ${suspendUntil.toLocaleString('es-CO')}.`);
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[120px] p-4 mt-2 border-2 border-orange-200 rounded-xl focus:border-orange-400 focus:ring-0 resize-none text-base"
                    required
                  />
                </div>
